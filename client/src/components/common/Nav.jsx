...
export default function Nav() {
  ...
  return ( 
    <header className="bg-white w-11/12  mx-auto    ">
      <nav className="mx-auto flex  items-center justify-between p-4 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1 gap-5 justify-start items-center">
          ...
          <div  className='  w-full  flex  items-center relative' >
            ...
            <input  className=' form-style   ' type="text" placeholder=' Search' />
