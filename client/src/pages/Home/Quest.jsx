...
export default function CarouselQuest() {
  useEffect(() => {
    ...
    <>
      <div className="glide-01 relative w-[11/12] ">
        {/* <div className="max-w-screen-lg mx-auto py-4">
          ...
          <p className="text-center mt-4 font-medium text-slate-500">- Miorena tsara -</p>
            ...
            <li>
              <div className=" bg-white  shadow rounded-lg overflow-hidden flex flex-col">
                ...
                <div className="p-6 flex flex-col flex-1">
                  <span className="block text-slate-400 font-semibold text-sm">16 Juillet 2016</span>
                  ...
                  <h2 className="text-xs text-slate-400 mb-3">Docteur Irako Andriamahasoa Ammi</h2>
